...
public sealed class FlammableAndExplosive : ExusiaiCardTemplate
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<FlammableAndExplosivePower>(5m)];
    ...
    protected override void OnUpgrade() =>
        DynamicVars[nameof(FlammableAndExplosivePower)].UpgradeValueBy(2m);
}
