...
| 仓库路径 | 类型 | 来源 | 项目用途 | 修改 | 备注 |
|---|---|---|---|---|---|
| `references/free/art/弹药.svg` | SVG 图标 | 项目维护者提供 | 弹药资源的小图标与战斗计数器图标 | 源文件未修改，复制为 `AK_Exusiai/images/ui/ammo.svg` | 原始作者或授权链接尚待维护者补充 |
...
| `references/free/art/干扰.svg` | SVG 图标 | 项目维护者提供（原文件名“闪光.svg”） | 新“干扰”敌人减益图标 | 仅按新机制改名，复制为 `AK_Exusiai/images/powers/InterferencePower.svg` | 原始作者或授权链接尚待维护者补充 |
| `references/free/art/天使之心.svg` | SVG 图标 | 项目维护者提供 | 已弃用旧“天使之心”能力的历史源图 | 源文件未修改，当前不接入运行时 | 原始作者或授权链接尚待维护者补充 |
...
| `references/free/art/Free_delivery_power.png` | PNG 图标 | 项目维护者提供 | “免费派送”能力图标 | 源文件未修改，复制为 `AK_Exusiai/images/powers/FreeCardsPower.png` | 原始作者或授权链接尚待维护者补充 |
...
| `references/free/art/火力电台.png` | PNG 遗物图 | 项目维护者提供 | “火力电台 / Firepower FM”遗物图标 | 脚本裁切、等比缩放并生成 `FirepowerFm.png` 与白色轮廓图 | 原始作者或授权链接尚待维护者补充 |
