...
Card-Loc $zhs 'CROSS_OF_DEVOTION' '虔心十字' '造成{Damage:diff()}点伤害[blue]2[/blue]次。为一张手牌添加[gold]天使[/gold]。' '选择一张手牌添加天使。'
Card-Loc $zhs 'VIOLENT_DELIVERY' '暴力运输' '使随机一个遗物获得[gold]快递{Delivery:diff()}[/gold]。造成{Damage:diff()}点伤害。'
Card-Loc $zhs 'FREE_DELIVERY' '免费派送' '抽[blue]1[/blue]张牌。获得[gold]中转{Transit:diff()}[/gold]头环。'
Card-Loc $zhs 'QUICK_MAG' '快速弹匣' '获得{Ammo:diff()}发[gold]弹药[/gold]。抽[blue]2[/blue]张牌。'
Card-Loc $zhs 'HOLY_CITY_RADIANCE' '圣城威光' '你每有一张[gold]天使[/gold]牌，此牌造成{Damage:diff()}点伤害[blue]1[/blue]次。{InCombat:\n（命中{CalculatedHits:diff()}次）|}'
Card-Loc $zhs 'PARTY_TIME' '派对时间！' '造成{Damage:diff()}点伤害[blue]15[/blue]次。在你的手牌中加入一张[gold]睡眠不佳[/gold]。'
Card-Loc $zhs 'STEADFAST_HEART' '坚定之心' '获得{Block:diff()}点[gold]格挡[/gold]。在你的手牌中加入[blue]2[/blue]张[gold]受伤[/gold]。'
Card-Loc $zhs 'TARGET_THE_WEAK_SPOT' '瞄准弱点！' '如果一名敌人有负面状态，获得{FirepowerPower:diff()}点[gold]火力[/gold]。'
Card-Loc $zhs 'OUTSTANDING_GRADUATE' '优秀毕业生' '使所有敌人的[gold]干扰[/gold]层数{IfUpgraded:show:变为三倍|翻倍}，并给予所有敌人[blue]1[/blue]层干扰。'
Card-Loc $zhs 'LOAN' '借贷' '获得{Gold:diff()}金币。将一张[gold]债务[/gold]加入你的抽牌堆。'
Card-Loc $zhs 'EMPATHY_FORM' '共感形态' '在回合开始时，为[blue]1[/blue]张手牌添加[gold]天使[/gold]。每打出[blue]1[/blue]张天使牌，抽[blue]1[/blue]张牌。'
Card-Loc $zhs 'HOLY_CITY_GUIDANCE' '圣城指引' '抽{Cards:diff()}张牌。'
Card-Loc $zhs 'MAY_THE_LORD_GUIDE_US' '愿主指引' '造成{Damage:diff()}点伤害。在你的手牌中加入一张[gold]{IfUpgraded:show:圣城指引+|圣城指引}[/gold]。'
Card-Loc $zhs 'BOTCHED_MODIFICATION' '改装不当' '对所有敌人造成{Damage:diff()}点伤害[blue]2[/blue]次。在你的手牌中加入一张[gold]悔恨[/gold]。'
Card-Loc $zhs 'WHAT_LIES_AHEAD' '前路何在？' '造成{Damage:diff()}点伤害[blue]3[/blue]次。在你的手牌中加入一张[gold]茫然[/gold]。'
Card-Loc $zhs 'SWEAR_ON_THIS_GUN' '以铳起誓' '造成{Damage:diff()}点伤害。在你的手牌中加入一张[gold]{IfUpgraded:show:圣城净化+|圣城净化}[/gold]。'
Card-Loc $zhs 'SHOOTING_MODE' '扫射模式' '造成{Damage:diff()}点伤害[blue]4[/blue]次。'
Card-Loc $zhs 'CHAOTIC_RAMPAGE' '混乱狂飙' '抽[blue]3[/blue]张牌。在你的手牌中加入一张[gold]{IfUpgraded:show:孢子心灵|歧途}[/gold]。'
Card-Loc $zhs 'PENGUIN_STANDARD' '企鹅标快' '选择一个遗物获得[gold]快递{Delivery:diff()}[/gold]。获得[blue]2[/blue]个[gold]中转{Transit:diff()}[/gold]随机遗物。'
...
Card-Loc $zhs 'HOLY_CITY_MERCY' '圣城怜悯' '获得[blue]8[/blue]点[gold]格挡[/gold]。为手牌中所有非[gold]天使[/gold]牌添加天使。'
Card-Loc $zhs 'TALENT' '天赋' '{IfUpgraded:show:给予所有敌人[blue]1[/blue]层[gold]干扰[/gold]。|}敌人每有一层干扰，受到的伤害提升[blue]10%[/blue]。'
Card-Loc $zhs 'HOLY_CITY_CALLING' '圣城感召' '你在一回合内打出不少于[blue]3[/blue]张[gold]天使[/gold]牌时，在本回合获得[gold]翱翔[/gold]。'
Card-Loc $zhs 'THE_SAINTS_TRAVELS' '圣徒行记' '获得[blue]1[/blue]点[gold]火力[/gold]。这张牌在本局游戏中的火力值永久性增加[blue]1[/blue]。'
...
Card-Loc $eng 'CROSS_OF_DEVOTION' 'Cross of Devotion' 'Deal {Damage:diff()} damage [blue]2[/blue] times. Give a card in your hand [gold]Angel[/gold].' 'Choose a card in your hand to gain Angel.'
Card-Loc $eng 'VIOLENT_DELIVERY' 'Violent Delivery' 'Give a random relic [gold]Delivery {Delivery:diff()}[/gold]. Deal {Damage:diff()} damage.'
Card-Loc $eng 'FREE_DELIVERY' 'Free Delivery' 'Draw [blue]1[/blue] card. Obtain a Circlet with [gold]Transit {Transit:diff()}[/gold].'
Card-Loc $eng 'QUICK_MAG' 'Quick Mag' 'Gain {Ammo:diff()} [gold]Ammo[/gold]. Draw [blue]2[/blue] cards.'
Card-Loc $eng 'HOLY_CITY_RADIANCE' 'Holy City Radiance' 'For each [gold]Angel[/gold] card you have, deal {Damage:diff()} damage [blue]1[/blue] time. {InCombat:\n(Hits {CalculatedHits:diff()} times)|}'
Card-Loc $eng 'PARTY_TIME' 'Party Time!' 'Deal {Damage:diff()} damage [blue]15[/blue] times. Add a [gold]Poor Sleep[/gold] to your hand.'
Card-Loc $eng 'STEADFAST_HEART' 'Steadfast Heart' 'Gain {Block:diff()} [gold]Block[/gold]. Add [blue]2[/blue] [gold]Injuries[/gold] to your hand.'
...
Card-Loc $eng 'OUTSTANDING_GRADUATE' 'Outstanding Graduate' '{IfUpgraded:show:Triple|Double} the [gold]Interference[/gold] on ALL enemies, then apply [blue]1[/blue] Interference to ALL enemies.'
Card-Loc $eng 'LOAN' 'Loan' 'Gain {Gold:diff()} Gold. Add a [gold]Debt[/gold] to your draw pile.'
Card-Loc $eng 'EMPATHY_FORM' 'Empathy Form' 'At the start of your turn, give [blue]1[/blue] card in your hand [gold]Angel[/gold]. Whenever you play an Angel card, draw [blue]1[/blue] card.'
Card-Loc $eng 'HOLY_CITY_GUIDANCE' 'Holy City Guidance' 'Draw {Cards:diff()} cards.'
Card-Loc $eng 'MAY_THE_LORD_GUIDE_US' 'May the Lord Guide Us' 'Deal {Damage:diff()} damage. Add a [gold]{IfUpgraded:show:Holy City Guidance+|Holy City Guidance}[/gold] to your hand.'
Card-Loc $eng 'BOTCHED_MODIFICATION' 'Botched Modification' 'Deal {Damage:diff()} damage to ALL enemies [blue]2[/blue] times. Add a [gold]Regret[/gold] to your hand.'
Card-Loc $eng 'WHAT_LIES_AHEAD' 'What Lies Ahead?' 'Deal {Damage:diff()} damage [blue]3[/blue] times. Add a [gold]Bewildered[/gold] to your hand.'
Card-Loc $eng 'SWEAR_ON_THIS_GUN' 'Swear on This Gun' 'Deal {Damage:diff()} damage. Add a [gold]{IfUpgraded:show:Holy City Purge+|Holy City Purge}[/gold] to your hand.'
Card-Loc $eng 'SHOOTING_MODE' 'Shooting Mode' 'Deal {Damage:diff()} damage [blue]4[/blue] times.'
Card-Loc $eng 'CHAOTIC_RAMPAGE' 'Chaotic Rampage' 'Draw [blue]3[/blue] cards. Add a [gold]{IfUpgraded:show:Spore Mind|Wayward}[/gold] to your hand.'
Card-Loc $eng 'PENGUIN_STANDARD' 'Penguin Standard' 'Choose a relic to gain [gold]Delivery {Delivery:diff()}[/gold]. Obtain [blue]2[/blue] random relics with [gold]Transit {Transit:diff()}[/gold].'
...
Card-Loc $eng 'HOLY_CITY_MERCY' 'Holy City Mercy' 'Gain [blue]8[/blue] [gold]Block[/gold]. Give every non-[gold]Angel[/gold] card in your hand Angel.'
Card-Loc $eng 'TALENT' 'Talent' '{IfUpgraded:show:Apply [blue]1[/blue] [gold]Interference[/gold] to ALL enemies. |}Enemies take [blue]10%[/blue] more damage for each Interference they have.'
...
Card-Loc $eng 'THE_SAINTS_TRAVELS' "The Saints' Travels" 'Gain [blue]1[/blue] [gold]Firepower[/gold]. Permanently increase the Firepower of this card by [blue]1[/blue] this run.'
