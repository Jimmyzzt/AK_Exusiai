...
Card-Loc $zhs 'FREE_DELIVERY' '免费派送' '抽[blue]1[/blue]张牌。获得[gold]中转{Transit:diff()}[/gold][gold]{MysteryRelic}[/gold]。'
...
Card-Loc $zhs 'CHAOTIC_RAMPAGE' '混乱狂飙' '抽{Cards:diff()}张牌。在弃牌堆中加入一张[gold]歧途[/gold]。'
...
Card-Loc $eng 'FREE_DELIVERY' 'Free Delivery' 'Draw [blue]1[/blue] card. Gain a [gold]Transit {Transit:diff()}[/gold] [gold]{MysteryRelic}[/gold].'
...
Card-Loc $eng 'CHAOTIC_RAMPAGE' 'Chaotic Rampage' 'Draw {Cards:diff()} cards. Add a [gold]Wayward[/gold] to your Discard Pile.'
